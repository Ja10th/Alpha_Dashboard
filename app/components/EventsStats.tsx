        ...
        <div className="relative flex flex-col md:flex-row gap-4">
          {statsData.map(({ id, name, value, trend, isUp }) => (
            <motion.div
              ...
              className={`relative w-[400px] md:w-[270px] h-[88px] hover:scale-105 transform transition-transform ease-in-out duration-300 cursor-pointer border p-4 rounded-sm ${
